...
class historia:
    def __init__(self, top=None):
        ...
        self.inicionuevo = ttk.Button(top)
        self.inicionuevo.place(relx=0.15, rely=0.8, height=25, width=136)
        self.inicionuevo.configure(takefocus="")
        self.inicionuevo.configure(text='''Iniciar nuevo estudio''')
        self.inicionuevo.configure(command=estudios.vp_start_gui)

        self.Scrolledlistbox1 = ScrolledListBox(top)
        self.Scrolledlistbox1.place(relx=0.133, rely=0.333, relheight=0.389
                , relwidth=0.735)
        ...
        self.Scrolledlistbox1.configure(listvariable=historial_support.pacientes)
